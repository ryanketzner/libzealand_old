...
int main(void)
{
    std::string path_full = std::string(PROJECT_ROOT_DIR) + "/build/examples/output/spherecone_full";
    std::string path_partial = std::string(PROJECT_ROOT_DIR) + "/build/examples/output/spherecone_partial";
